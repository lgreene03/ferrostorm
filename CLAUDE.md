...
## Data conventions
- All gameplay numbers live in /data as YAML: units, buildings, fields, weapons, the AI's tuning and GDD s6's damage matrix. Hand-editing stats in code is forbidden. **This sentence became true on 2026-08-03** (P7-15, ADR-057): the matrix was the last holdout, carrying a Phase 1 comment promising the wiring, and it is the one number that decides what every shot in the game DOES rather than what a player may build.
