...
| **Q017 COMPLETE** | All three of DR-02/03/04 shipped 2026-08-01 | C | - | 3 rows, goldens NEUTRAL on all three | The asymmetry pillar, which doc 27 called the least delivered of the GDD's five, now has the two sides differing in their power grid, their answer to cloak and their superweapon. What remains is the AI, which builds none of it |
